...
if nargout<2
    ...
    fIO=x(s.bundle.serial.IO.dest(s.bundle.serial.IO.obs))-...
        s.IO.prior.val(s.bundle.serial.IO.src(s.bundle.serial.IO.obs));
            
    % ...EO residuals...
    fEO=x(s.bundle.serial.EO.dest(s.bundle.serial.EO.obs))-...
        s.EO.prior.val(s.bundle.serial.EO.src(s.bundle.serial.EO.obs));

    % ...OP residuals...
    fOP=x(s.bundle.serial.OP.dest(s.bundle.serial.OP.obs))-...
        s.OP.prior.val(s.bundle.serial.OP.src(s.bundle.serial.OP.obs));
