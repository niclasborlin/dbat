function [p,dp0,df,dP,dC,dAng]=eulerpinhole2(p0,f,P,C,ang,ax,cp0,cf,cP,cC,cAng)
%EULERPINHOLE2 General pinhole camera projection with Euler angles.
%
%    EULERPINHOLE2(P,C,ANG,AX,F,PP,FA,FS) computes 
...
if nargout==1
    ...
    % Project rotated point into camera.
    [p,dpdp0,dpdf,dpdT]=pinhole(P,f,f0,p0,f,T,cp0,cf,any(cP(:)) | cC | cAng);
