...
%or
%[OP,A]=pm_forwintersect1(P,xy,'homogenous')
%P      - 3nx4 matrix with 3x4 camera matrices [P1;P2;...].
%xy     - 2xn or 3xn matrix with euclidean or homogenous point coordinates.
%method - 'homogenous' or 'euclidean' (default).
%OP     - 3-vector (euclidean input) or 4-vector (homogenous input) with
%         estimated point. 
%OPc    - 3xn or 4xn matrix with closest point on each line (method=euclidean).
%A      - homogenous matrix A such that A*OP approx 0 (method=homogenous).

% v1.0  2005-02-16. Niclas Borlin, niclas@cs.umu.se.
