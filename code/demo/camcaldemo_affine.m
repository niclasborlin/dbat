...
% Switch to another lens distortion model for all cameras.
% 1 - Legacy Photogrammetry, no affine (fast)
% 2 - Flexible Photogrammetry, no affine (replica of 1)
% 3 - Photogrammetry, affine before lens distortion
...
% The following elements of IO can be estimated
% 1 - px
% 2 - py
% 3 - f
% 4 - K1
...
% 7 - P1
% 8 - P2
% 9 - B1 (aspect will be 1+B1:1)
%10 - B2 (skew)
%s0.estIO(1:8,:)=true;
s0.estIO(ismember(1:16,[1:10]),:)=true;
