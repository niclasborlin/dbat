function [rr,s0,psz]=stpierrebundledemo_ps_brown
...
[psz,prob,s0,s0PreFilt]=loadplotpsz(psz,true,[3,5]);
...
if s0.IOdistModel(1)>0
    % Report file name.
    reportFile=fullfile(tempdir,'stpierrePS_C5-dbatreport-bb.txt');
else
    % Report file name.
    reportFile=fullfile(tempdir,'stpierrePS_C5-dbatreport-fb.txt');
end
