...
%   scalar or logical N-vector. The function returns OK as TRUE if all
%   mandatory fields are present and no unknown field.
%
...
if isscalar(mandatory), mandatory=repmat(mandatory,size(fields)); end
