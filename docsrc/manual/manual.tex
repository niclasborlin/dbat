...
\item Download the package file {\tt
  \verb+dbat_+\dbatversion\verb+.zip+}\footnote{Soon to appear on \url{https://github.com/niclasborlin/dbat}.}.
...
PhotoModelere text export file. Two examples are included in the
